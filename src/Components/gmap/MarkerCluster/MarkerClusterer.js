...
//   window.google.maps.event.trigger(markerClusterer, 'clusterclick', this.cluster_, event);
...
//   window.google.maps.event.addDomListener(this.div_, 'click', function(event) {
...
//     isDragging = false;
//   });
//   window.google.maps.event.addDomListener(this.div_, 'mousemove', function() {
//     isDragging = true;
//   });
// };
