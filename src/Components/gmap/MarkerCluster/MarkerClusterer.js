...
// @externs_url http://closure-compiler.window.googlecode.com/svn/trunk/contrib/externs/maps/window.google_maps_api_v3_3.js
// ==/ClosureCompiler==

/**
 * @name MarkerClusterer for window.google Maps v3
 ...
 *
 * @param {window.google.maps.Map} map The window.google map to attach to.
 * @param {Array.<window.google.maps.Marker>=} opt_markers Optional markers to add to
 *   the cluster.
...
function MarkerClusterer(map, opt_markers, opt_options) {
  ...
  /**
   * @type {Array.<window.google.maps.Marker>}
   * @private
   */
  this.markers_ = [];
  ...
  var that = this;
  window.google.maps.event.addListener(this.map_, 'zoom_changed', function() {
  ...
  window.google.maps.event.addListener(this.map_, 'idle', function() {
    that.redraw();
  });
 ...
 *
 *  @return {Array.<window.google.maps.Marker>} The markers.
 */
 ...
 *
 *  @param {Array.<window.google.maps.Marker>} markers The markers in the clusterer.
...
/**
 * Returns the window.google map that the clusterer is associated with.
 *
...
/**
 * Sets the window.google map that the clusterer is associated with.
 *
 * @param {window.google.maps.Map} map The map.
 */
...
MarkerClusterer.prototype.createClusters_ = function() {
  ...
  var mapBounds = new window.google.maps.LatLngBounds(this.map_.getBounds().getSouthWest(),
 ...
 *
 * @return {Array.<window.google.maps.Marker>} The markers in the cluster.
 */
 ...
 *
 * @return {window.google.maps.LatLng} The cluster center.
 */
...
ClusterIcon.prototype.triggerClusterClick = function() {
  ...
  window.google.maps.event.trigger(markerClusterer.map_, 'clusterclick', this.cluster_);
...
ClusterIcon.prototype.draw = function() {
  if (this.visible_) {
    ...
    this.div_.style.zIndex = window.google.maps.Marker.MAX_ZINDEX + 1;
  }
};
 ...
 *
 * @param {window.google.maps.Point} pos The position.
